...
"BitcoinPercentDif", "EthereumPercentDif", 'TetherPercentDif', 'SolanaPercentDif', 'BinancePercentDif', 'CardanoPercentDif'
...
allfile['high']= sorted(allfile['BitcoinPercentDif'], reverse=True)
Bithigh = allfile['Bithigh'][:10]
print(Bithigh)
