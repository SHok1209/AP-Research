...
allfile.plot(x = 'Date', y = ["BitcoinPercentDif", 'BinancePercentDif', 'CardanoPercentDif', 'AvalanchePercentDif', 'LitecoinPercentDif'])
plt.title('crypto change ')
plt.xlabel('Date')
plt.xlim('2024-12-31', '2024-12-01')  
plt.ylabel('Percent Difference')
plt.show()
plt.savefig('percentWITHsupplyDEC.png')